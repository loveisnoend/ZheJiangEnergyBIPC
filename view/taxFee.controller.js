		...
		this.getView().addEventDelegate({
			...
			onAfterShow: jQuery.proxy(function(evt) {
		        ...
		        //AC-Gates 更改下面的文字和onclick方法
                                "<b onClick='toPureProfitPage()' style='cursor:pointer;'>浙能电力净利润</b> > <b>"+timeLabel+"所得税费用</b>"+
                                "</span>";
...
// 			myChart3.setOption(option3);
			...
			document.getElementById('powerPlantMainDetailTitleTaxFee').innerHTML = '浙能电力股份有限公司'
			//////////////////////////////////浙江省地图//////////////////////////////////////////////////////////		
			// 基于准备好的dom，初始化echarts图表
