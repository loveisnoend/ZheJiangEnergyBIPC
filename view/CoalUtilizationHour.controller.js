sap.ui.controller("com.zhenergy.pcbi.view.CoalUtilizationHour", {
	onInit: function() {
...
// 		}
		...
		mParameters['success'] = jQuery.proxy(function(sRes) {
			...
			for (var i in sRes.results) {
				...
				if (sRes.results[i].KPI_TYPE == '浙江省煤电利用小时(当月)' && sRes.results[i].KPI_DESC == '煤电') {
	...
	loadChart: function(date, data) {
		...
		function draw(e) {
			mychart = e.init(document.getElementById('CoalUtilizationHourChart'));
			var option = {
				title: {
					show: false,
