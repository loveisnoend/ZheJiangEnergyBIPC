sap.ui.controller("com.zhenergy.pcbi.view.averPersonProfitRecord", {
	...
	onInit: function() {
		this.getView().addEventDelegate({
			...
			onAfterShow: jQuery.proxy(function(evt) {
			    ...
			    var sIdentical = "AverPersonProfitRecord";
		        ...
		        //AC-Gates 更改下面的文字和onclick方法
                                "<b onClick='toAverPersonProfitRealPage()' style='cursor:pointer;'>浙能电力人均利润</b> > <b>"+timeLabel+"人均营业收入</b>"+
                                "</span>";
	...
	onAfterShow: function() {
		...
		document.getElementById('internetDetailAverPersonProfitRecord').style.display = "";
		document.getElementById('rlcb_detailAverPersonProfitRecord').style.display = "none";
		// this.loadChart();
		this._loadData01();
		// 设定头部跑马灯信息 common.js
	...
	// 		function draw(e){
	// 		    document.getElementById('caloriAverPersonProfitRecordPlantNameAverPersonProfitRecord').innerHTML = document.getElementById('powerPlantMainDetailTitleAverPersonProfitRecord').innerHTML;
	...
	// 获取集团指标-人均营业收入 SCREEN_FZBZ_02_V02
	loadBase_SupplyAverPersonProfitRecordIncome: function(chartDivId, priceChartName) {
...
// 			var mychart = e.init(document.getElementById(chartDivId));
	...
	// 加载集团-人均营业收入指标
	loadBaseDataDetail_AverPersonProfitRecordIncome: function(chartDivId, priceChartName, xData, KPI_RLC_V, KPI_RLC_UP) {
		require(
            [
                'echarts',
                'echarts/chart/line',
		...
		function draw(e) {
			...
			//	document.getElementById('profitNameAverPersonProfitRecord').innerHTML = document.getElementById(
			//		'powerPlantMainDetailTitleAverPersonProfitRecord').innerHTML;
			var color1 = '#A704CA';
			var color2 = '#E52DE6';
			var option = {
				title: {
	...
	loadChart: function(map1Data, map2Data, map3Data, map4Data) {
		...
		function draw(e) {
			drawAverPersonProfitRecordDistribution(e);
		...
		function drawAverPersonProfitRecordDistribution(ec) {
...
// 			myChart3.setOption(option3);
			...
			document.getElementById('powerPlantMainDetailTitleAverPersonProfitRecord').innerHTML = '浙能电力股份有限公司'
			//////////////////////////////////浙江省地图//////////////////////////////////////////////////////////		
			// 基于准备好的dom，初始化echarts图表
			...
			///////////////////////////////安徽淮南市地图////////////////////////////////////////////
			// 基于准备好的dom，初始化echarts图表
			myChart5 = ec.init(document.getElementById('huaiNanMapAverPersonProfitRecord'));
			...
			///////////////////////////////新疆阿克苏地图////////////////////////////////////////////
			// 基于准备好的dom，初始化echarts图表
			myChart6 = ec.init(document.getElementById('akesuMapAverPersonProfitRecord'));
			...
			///////////////////////////////宁夏枣泉地图////////////////////////////////////////////
			// 基于准备好的dom，初始化echarts图表
			myChart7 = ec.init(document.getElementById('zaoquanMapAverPersonProfitRecord'));
		...
		function drawpie01(e) {
			drawpie(e, 3, 4, 'detail_pieAverPersonProfitRecord');
		}

		function drawbar01(e) {
			drawbar(e, 4, 6, 'detail_01AverPersonProfitRecord');
		}

		function drawbar02(e) {
			drawbar(e, 7, 3, 'detail_02AverPersonProfitRecord');
		}

		function drawbar03(e) {
			drawbar(e, 3, 7, 'detail_03AverPersonProfitRecord');
		}

		function drawbar04(e) {
			drawbar(e, 8, 2, 'detail_04AverPersonProfitRecord');
		}
		// 设置Chart的数据
		function setChartData(ec, mapSeries, dataIndex) {
			...
			document.getElementById('powerPlantMainDetailTitleAverPersonProfitRecord').innerHTML = powerPlantName;

			var priceChartId = "priceDetailDivAverPersonProfitRecord";
