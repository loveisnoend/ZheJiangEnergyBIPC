sap.ui.controller("com.zhenergy.pcbi.view.SocialEleCons", {
onInit: function() {
	...
	_loadData01: function() {
		...
		mParameters['success'] = jQuery.proxy(function(sRes) {
			...
			for (var i in sRes.results) {
				...
				if (sRes.results[i].KPI_TYPE == '省-社会用电量(当月)' && sRes.results[i].KPI_DESC == '浙江省') {
	...
	loadChart: function(date, data) {
		...
		function draw(e) {
			mychart = e.init(document.getElementById('SocialEleConsChart'));
			var option = {
				title: {
					show: false,
