sap.ui.controller("com.zhenergy.pcbi.view.businessProfit", {
	...
	// 获取浙能电力指标-营业利润 SCREEN_ZCQK_02_V01
...
// 			$('#businessProfitIncomeStatisticDate').html(dataStatisticDate);
		...
		sap.ui.getCore().getModel().read("AT_ZSCREEN_JYYJ_03_YYLR/?$filter=(BNAME eq '" + usrid + "')", mParameters);
	},
...
.innerHTML=="浙能电力"){
   document.getElementById('profitNameBusinessProfit').innerHTML="浙能电力股份有限公司";
}else{
...
// 			myChart3.setOption(option3);
			...
			document.getElementById('powerPlantMainDetailTitleBusinessProfit').innerHTML = '浙能电力股份有限公司'
			//////////////////////////////////浙江省地图//////////////////////////////////////////////////////////		
			// 基于准备好的dom，初始化echarts图表
