sap.ui.controller("com.zhenergy.pcbi.view.averPersonSalary", {
	...
	onInit: function() {
		this.getView().addEventDelegate({
			...
			onAfterShow: jQuery.proxy(function(evt) {
			    ...
			    var sIdentical = "AverPersonSalary";
		        ...
		        //AC-Gates 更改下面的文字和onclick方法
                                "<b onClick='toAverPersonProfitRealPage()' style='cursor:pointer;'>浙能电力人均利润</b> > <b>"+timeLabel+"人均工资</b>"+
                                "</span>";
	...
	// 获取浙能电力指标-人均工资 SCREEN_FZBZ_02_V02
	...
	loadBaseDataDetail_SupplyAverPersonSalaryIncome: function(chartDivId, priceChartName, xData, KPI_RJS_V, KPI_RJS_UP) {
		...
		function draw(e) {
			...
			if (document.getElementById('powerPlantMainDetailTitleAverPersonSalary')
				.innerHTML == "浙能电力") {
				document.getElementById('profitNameAverPersonSalary').innerHTML = "浙能电力股份有限公司";
			} else {
...
// 			myChart3.setOption(option3);
			...
			document.getElementById('powerPlantMainDetailTitleAverPersonSalary').innerHTML = '浙能电力股份有限公司'
			//////////////////////////////////浙江省地图//////////////////////////////////////////////////////////		
			// 基于准备好的dom，初始化echarts图表
