	...
	onInit: function() {
		this.getView().addEventDelegate({
			...
			onAfterShow: jQuery.proxy(function(evt) {
				...
				sap.ui.controller("com.zhenergy.pcbi.view.templates.dymcontents").onInsertMap(document,"AverPersonSalary");
			    //AC-LOUWW 页面增加动态的时间日期标签
				var myDate=new Date() ;
				var timeLabel = myDate.getFullYear() + "年" + myDate.getMonth() +"月"; //getMonth 1-12月对应0-11
				var naviDemo = document.getElementById("naviAverPersonSalary");
		        naviDemo.innerHTML =  "<span id='demo' style='height:100%;'>"+
                                "<b onClick='toAverPersonProfitPage()' style='cursor:pointer;'>浙能电力人均利润</b> > <b>"+timeLabel+"人均工资</b>"+
                                "</span>";
