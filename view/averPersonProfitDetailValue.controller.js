...
onInit: function() {
		this.getView().addEventDelegate({
			...
			onAfterShow: jQuery.proxy(function(evt) {
			    ...
			    var sIdentical = "averPersonProfitDetailValue";
		        ...
		        //AC-LOUWW 更改下面的文字和onclick方法
                                "<b onClick='toAverPersonProfitPage()' style='cursor:pointer;'>浙能电力人员构成分析</b> > <b>"+timeLabel+"人均利润</b>"+
                                "</span>";
...
.innerHTML=="浙能电力"){
   document.getElementById('profitNameaverPersonProfitDetailValue').innerHTML="浙能电力股份有限公司";
}else{
...
// 			myChart3.setOption(option3);
			...
			document.getElementById('powerPlantMainDetailTitleaverPersonProfitDetailValue').innerHTML = '浙能电力'
			//////////////////////////////////浙江省地图//////////////////////////////////////////////////////////		
			// 基于准备好的dom，初始化echarts图表
