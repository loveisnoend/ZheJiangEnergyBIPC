	...
	onInit: function() {
		this.getView().addEventDelegate({
			...
			onAfterShow: jQuery.proxy(function(evt) {
				...
				sap.ui.controller("com.zhenergy.pcbi.view.templates.dymcontents").onInsertMap(document,"WorkerCost");
			    //AC-LOUWW 页面增加动态的时间日期标签
				var myDate=new Date() ;
				var timeLabel = myDate.getFullYear() + "年" + myDate.getMonth() +"月"; //getMonth 1-12月对应0-11
				var naviDemo = document.getElementById("naviWorkerCost");
		        naviDemo.innerHTML =  "<span id='demo' style='height:100%;'>"+
                                "<b onClick='doit8(4)' style='cursor:pointer;'>发展保障</b> > <b>"+timeLabel+"电力股份单位效能</b>"+
                                "</span>";
	...
	loadBaseDataDetail_SupplyWorkerCostIncome: function(chartDivId, priceChartName, xData, KPI_RJS_V, KPI_RJS_UP) {
		...
		function draw(e) {
			...
			if (document.getElementById('powerPlantMainDetailTitleWorkerCost')
				.innerHTML == "集团") {
				document.getElementById('profitNameWorkerCost').innerHTML = "电力股份公司";
			} else {
